<?php
    ...
    function manejarDelete($entrada){
        ...
        if ($stmt) {
            ...
            echo json_encode(["mensaje" => "El estudio no se ha borrado correctamente."]);
        }
    }
    ...
    function manejarPut($entrada){
        ...
        if ($stmt) {
            ...
            echo json_encode(["mensaje" => "El estudio no se ha actualizado correctamente."]);
        }
    }
    ...
    function manejarPost($entrada) {
        ...
        if ($stmt) {
            ...
            echo json_encode(["mensaje" => "El estudio no se ha insertado correctamente."]);
        }
    }
